...
import {
  ActivityIndicator, Text, TextInput, useWindowDimensions, View,
} from 'react-native';
import {
  apiCuidarMascota,
  apiGetMascota,
...
const useStyles = makeThemedStyles((t) => ({
  ...
  enlaceReto: { minHeight: 44, alignSelf: 'flex-start', marginTop: 4, justifyContent: 'center' },
  ...
  enviarNombre: { minHeight: 44, backgroundColor: t.colors.accentSoft, borderRadius: t.shape.radiusSm, justifyContent: 'center', paddingHorizontal: 8 },
