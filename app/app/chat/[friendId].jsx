...
import {
  View, Text, FlatList, ScrollView, ActivityIndicator, TextInput,
} from 'react-native';
...
function Burbuja({
  ...
  return (
    <View style={[styles.burbujaFila, mensaje.mine ? styles.filaMia : styles.filaAjena]}>
      <View style={[styles.burbujaGrupo, mensaje.mine ? styles.grupoMio : styles.grupoAjeno]}>
        {mensaje.failed ? (
          <Tappable
