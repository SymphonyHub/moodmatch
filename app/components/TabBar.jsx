...
function TabItem({ options, route, focused, color, onPress, label, theme, styles }) {
  ...
  return (
    ...
    >
      ...
      <Animated.Text
        numberOfLines={1}
        style={[styles.label, focused && theme.typography.fonts.semibold, { color, opacity: labelOpacity }]}
      >
        {label}
      </Animated.Text>
    </Tappable>
